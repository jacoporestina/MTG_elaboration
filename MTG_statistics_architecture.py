...
def analyze_mtg_data(file_path, output_folder, excluded_columns):
    ...
    for date in data['date'].unique():
        ...
        for order_type in ['order1', 'order2']:
            ...
            columns_to_analyze = [col for col in order_data.columns[8:] if col not in excluded_columns]
...
file_path = "MTG_csv.csv"
output_folder = "output_statistics_architecture"
excluded_columns = ['phyllotaxis_absolute_(°)', 'length_petiolule_(mm)', 'inclination_petiolule_(°)', 'total_leaf_area_(m2)', 
